...
export default function FeaturesSection() {
    return (
        <div id="features" className="px-4 md:px-16 lg:px-24 xl:px-32">
            <SectionTitle text1="Features" text2="Why use our generator?" text3="Create stunning thumbnails that get clicks, without the hassel." />
            ...
            <div className="mt-40 relative mx-auto max-w-5xl">
                ...
                >
                    Our AI understands what makes a vedio go viral and designs thumbnails accordingly.
                </motion.p>
